...
public class ProductController {
	...
	@GetMapping("/getCostGreaterThan/{cost}")
	public List<Product> getCostGreaterThan(@PathVariable double cost){
	    return service.getProductsGreaterThan(cost);
	}

	@GetMapping("/searchProduct/{name}")
	public List<Product> searchProduct(@PathVariable String name){
	    return service.getProductsByNameContains(name);
	}
